            ...
            <div>
                {user
                    ...
                    <div className='flex items-center gap-2 sm:gap-3'>
                        ...
                        <button onClick={() => navigate('/buy')} className='flex items-center gap-2 bg-purple-100 px-4 sm:px-6 
                        ...
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 z-10 pt-12 text-black rounded'>
